...
- Let the hero stay editorial, but center the body copy independently from it.
- Keep a strong centered reading column and let visuals punctuate the story.
- Put `On This Page` in a compact left gutter on desktop.
- Reserve a right gutter for sources, read-next, or secondary context without letting it push the reading column off center.
